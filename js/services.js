...
.factory('Results', function($http, $q) {
	...
	return {
		...
		updateToServer: function(result) {
			var deferred = $q.defer();
			$http.put(url + '/' + result.id, {
					// url: url + '/' + result.id,
					// method: 'PATCH',
					// data: {
					'value': result.value,
...
// .factory('ResultRest', function($resource) {
//   var url = 'http://' + Config.HOST + ':8008/result-rest/:id';
